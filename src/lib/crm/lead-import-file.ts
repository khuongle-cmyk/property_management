...
function rowFromObject(obj: Record<string, unknown>, rowNumber: number): ParsedImportRow {
  ...
  return {
    ...
    contact_direct_phone: g(["contact_phone_direct", "contact_direct_phone", "direct_phone", "Direct phone"]) || null,
    email,
    phone: g(["phone", "Phone"]) || null,
    source: normalizeLeadSource(g(["source", "Source"]) || undefined),
    business_id: g(["company_registration", "business_id", "y_tunnus", "Y-tunnus"]) || null,
    vat_number: vatRaw ? vatRaw.toUpperCase() : null,
    company_type: normalizeLeadCompanyType(g(["company_type", "Company type"]) || undefined),
    industry_sector: g(["industry", "industry_sector", "Industry"]) || null,
    company_size: normalizeLeadCompanySize(g(["company_size", "Company size"]) || undefined),
    company_website: g(["website", "company_website", "Website"]) || null,
    billing_street: g(["billing_address", "billing_street", "Street", "street"]) || null,
    ...
    e_invoice_operator_code: g(["e_invoice_operator", "e_invoice_operator_code", "operator_code", "Operator code"]) || null,
